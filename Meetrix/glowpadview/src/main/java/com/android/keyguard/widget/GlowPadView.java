...
import com.starrepublic.glowpadview.R;
...
public class GlowPadView extends View {
    ...
    public interface OnTriggerListener {
        ...
        void onSnapped(View v, int target);
        void onTracking(View v, int handle);
    }
    ...
    public GlowPadView(Context context, AttributeSet attrs) {
        ...
        handleAnimator.addUpdateListener(new AnimatorUpdateListener(){

            @Override
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                mHandleDrawable.setAlpha(valueAnimator.getAnimatedFraction());
            }
        });
        handleAnimator.setDuration(200);
        ...
        mCloudColor = a.getColor(R.styleable.GlowPadView_cloudColor, Color.WHITE);
        ...
        mPointCloud = new PointCloud(pointDrawable,mCloudColor);
    ...
    private void dispatchTrackEvent() {
        if (mOnTriggerListener != null) {
            mOnTriggerListener.onTracking(this, snapTarget);
        }
    }

    private void dispatchSnapEvent() {
        if (mOnTriggerListener != null) {
            mOnTriggerListener.onSnapped(this, snapTarget);
        }
    }
    ...
    public void setHandleDrawable(int resourceId) {
        ...
        mHandleDrawable = new TargetDrawable(res, resourceId);
        mHandleDrawable.setState(TargetDrawable.STATE_INACTIVE);
    }
}
